...
// const ford = new Car('Ford', 'blue', '5353535353', 10);
...
//     set celsius(value) {
//         if (value < -273.15) {
//             console.log("Неможлива температура нижче абсолютного нуля.");
//             return;
//         }
//         this._celsius = value;
//     }
